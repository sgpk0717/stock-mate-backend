...
class ProgramTrading(Base):
    ...
    arbt_buy_amount: Mapped[int] = mapped_column(BigInteger, server_default="0")
    arbt_sell_amount: Mapped[int] = mapped_column(BigInteger, server_default="0")
    nabt_buy_amount: Mapped[int] = mapped_column(BigInteger, server_default="0")
    nabt_sell_amount: Mapped[int] = mapped_column(BigInteger, server_default="0")
    collected_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), server_default=func.now()
    )
